...
pub struct Etf {
    ...
    pub quote_strategy: ::core::option::Option<EtfQuoteStrategy>,
    /// 설정 단위
    #[prost(int64, tag="8")]
...
pub struct EtfLpStatus {
    ...
    /// Quote 전략
    #[prost(message, optional, tag="6")]
    pub strategy: ::core::option::Option<EtfQuoteStrategy>,
}
/// 주문 통계
#[allow(clippy::derive_partial_eq_without_eq)]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct UpdateEtfQuoteStrategyRequest {
    /// 새로운 Quote 전략
