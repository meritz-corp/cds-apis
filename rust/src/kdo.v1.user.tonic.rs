...
pub mod user_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_me(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("kdo.v1.user.UserService", "GetMe"));
        ...
        pub async fn get_user(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("kdo.v1.user.UserService", "GetUser"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod user_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/kdo.v1.user.UserService/GetMe" => {
                    ...
                    struct GetMeSvc<T: UserService>(pub Arc<T>);
                    ...
                    for GetMeSvc<T> {
                        ...
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            ...
                            let fut = async move {
                                <T as UserService>::get_me(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: UserService> tonic::server::NamedService for UserServiceServer<T> {
        const NAME: &'static str = "kdo.v1.user.UserService";
    }
}
