        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "kdo.v1.notification.NotificationService",
                        "ListNotifications",
                    ),
                );
        ...
        pub async fn subscribe_notifications(
            &mut self,
            request: impl tonic::IntoRequest<super::SubscribeNotificationsRequest>,
        ) -> std::result::Result<
        ...
        pub async fn acknowledge_notification(
            &mut self,
            request: impl tonic::IntoRequest<super::AcknowledgeNotificationRequest>,
...
pub mod notification_service_server {
    ...
    pub trait NotificationService: Send + Sync + 'static {
        async fn list_notifications(
            ...
            tonic::Status,
        >;
        /// Server streaming response type for the SubscribeNotifications method.
        type SubscribeNotificationsStream: tonic::codegen::tokio_stream::Stream<
        ...
        async fn subscribe_notifications(
            &self,
            request: tonic::Request<super::SubscribeNotificationsRequest>,
        ) -> std::result::Result<
            tonic::Response<Self::SubscribeNotificationsStream>,
            tonic::Status,
        >;
        async fn acknowledge_notification(
            &self,
            request: tonic::Request<super::AcknowledgeNotificationRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/kdo.v1.notification.NotificationService/SubscribeNotifications" => {
                    #[allow(non_camel_case_types)]
                    struct SubscribeNotificationsSvc<T: NotificationService>(pub Arc<T>);
                    impl<
                        T: NotificationService,
                    > tonic::server::ServerStreamingService<
                        super::SubscribeNotificationsRequest,
                    > for SubscribeNotificationsSvc<T> {
                        type Response = super::Notification;
                        type ResponseStream = T::SubscribeNotificationsStream;
                        type Future = BoxFuture<
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NotificationService>::subscribe_notifications(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SubscribeNotificationsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.notification.NotificationService/AcknowledgeNotification" => {
                    #[allow(non_camel_case_types)]
                    struct AcknowledgeNotificationSvc<T: NotificationService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: NotificationService,
                    > tonic::server::UnaryService<super::AcknowledgeNotificationRequest>
                    for AcknowledgeNotificationSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            request: tonic::Request<
                                super::AcknowledgeNotificationRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NotificationService>::acknowledge_notification(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = AcknowledgeNotificationSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    for NotificationServiceServer<T> {
        const NAME: &'static str = "kdo.v1.notification.NotificationService";
    }
}
