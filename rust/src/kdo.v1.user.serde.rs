...
impl serde::Serialize for GetUserRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.user.GetUserRequest", len)?;
        if true {
...
impl<'de> serde::Deserialize<'de> for GetUserRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.user.GetUserRequest")
            }
        ...
        deserializer.deserialize_struct("kdo.v1.user.GetUserRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListUsersRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.user.ListUsersRequest", len)?;
        if true {
...
impl<'de> serde::Deserialize<'de> for ListUsersRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.user.ListUsersRequest")
            }
        ...
        deserializer.deserialize_struct("kdo.v1.user.ListUsersRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListUsersResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.user.ListUsersResponse", len)?;
        if true {
...
impl<'de> serde::Deserialize<'de> for ListUsersResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.user.ListUsersResponse")
            }
...
impl serde::Serialize for User {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.user.User", len)?;
        if true {
        ...
        if true {
            struct_ser.serialize_field("employee_id", &self.employee_id)?;
        }
        if true {
        ...
        if true {
            struct_ser.serialize_field("is_admin", &self.is_admin)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for User {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.user.User")
            }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::EmployeeId => {
                            if employee_id__.is_some() {
                                return Err(serde::de::Error::duplicate_field("employeeId"));
                            }
                            employee_id__ = Some(map_.next_value()?);
                        }
                        GeneratedField::Ip => {
                            if ip__.is_some() {
        ...
        deserializer.deserialize_struct("kdo.v1.user.User", FIELDS, GeneratedVisitor)
    }
}
