...
impl serde::Serialize for ListFundsForCallerRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("kdo.v1.fund.ListFundsForCallerRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ListFundsForCallerRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListFundsForCallerRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.fund.ListFundsForCallerRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListFundsForCallerRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(ListFundsForCallerRequest {
                })
            }
        }
        deserializer.deserialize_struct("kdo.v1.fund.ListFundsForCallerRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListFundsForCallerResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.fund.ListFundsForCallerResponse", len)?;
        if true {
...
impl<'de> serde::Deserialize<'de> for ListFundsForCallerResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListFundsForCallerResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.fund.ListFundsForCallerResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListFundsForCallerResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(ListFundsForCallerResponse {
                    funds: funds__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("kdo.v1.fund.ListFundsForCallerResponse", FIELDS, GeneratedVisitor)
    }
}
