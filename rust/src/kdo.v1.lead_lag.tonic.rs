...
pub mod lead_lag_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_lead_lag_status(
            &mut self,
            request: impl tonic::IntoRequest<super::GetLeadLagStatusRequest>,
        ) -> std::result::Result<
            tonic::Response<super::LeadLagStatusUpdate>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.lead_lag.LeadLagService", "GetLeadLagStatus"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn list_lead_lag_trades(
            &mut self,
            request: impl tonic::IntoRequest<super::ListLeadLagTradesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListLeadLagTradesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_lead_lag_trade(
            &mut self,
            request: impl tonic::IntoRequest<super::GetLeadLagTradeRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.lead_lag.LeadLagService", "GetLeadLagTrade"),
                );
            self.inner.unary(req, path, codec).await
        }
...
pub mod lead_lag_service_server {
    ...
    pub trait LeadLagService: Send + Sync + 'static {
        ...
        async fn get_lead_lag_status(
            &self,
            request: tonic::Request<super::GetLeadLagStatusRequest>,
        ) -> std::result::Result<
            tonic::Response<super::LeadLagStatusUpdate>,
            tonic::Status,
        >;
        ...
        async fn get_lead_lag_trade_context(
            ...
            tonic::Status,
        >;
        async fn list_lead_lag_trades(
            &self,
            request: tonic::Request<super::ListLeadLagTradesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListLeadLagTradesResponse>,
            tonic::Status,
        >;
        async fn get_lead_lag_trade(
            &self,
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/kdo.v1.lead_lag.LeadLagService/GetLeadLagStatus" => {
                    #[allow(non_camel_case_types)]
                    struct GetLeadLagStatusSvc<T: LeadLagService>(pub Arc<T>);
                    impl<
                        T: LeadLagService,
                    > tonic::server::UnaryService<super::GetLeadLagStatusRequest>
                    for GetLeadLagStatusSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LeadLagService>::get_lead_lag_status(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetLeadLagStatusSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.lead_lag.LeadLagService/ListLeadLagTrades" => {
                    #[allow(non_camel_case_types)]
                    struct ListLeadLagTradesSvc<T: LeadLagService>(pub Arc<T>);
                    impl<
                        T: LeadLagService,
                    > tonic::server::UnaryService<super::ListLeadLagTradesRequest>
                    for ListLeadLagTradesSvc<T> {
                        type Response = super::ListLeadLagTradesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LeadLagService>::list_lead_lag_trades(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListLeadLagTradesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.lead_lag.LeadLagService/GetLeadLagTrade" => {
                    #[allow(non_camel_case_types)]
                    struct GetLeadLagTradeSvc<T: LeadLagService>(pub Arc<T>);
                    impl<
                        T: LeadLagService,
                    > tonic::server::UnaryService<super::GetLeadLagTradeRequest>
                    for GetLeadLagTradeSvc<T> {
                        type Response = super::LeadLagTradeRecord;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LeadLagService>::get_lead_lag_trade(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
