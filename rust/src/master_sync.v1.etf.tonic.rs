        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_etf(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/master_sync.v1.etf.EtfService/GetEtf",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("master_sync.v1.etf.EtfService", "GetEtf"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/master_sync.v1.etf.EtfService/ListEtfs",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("master_sync.v1.etf.EtfService", "ListEtfs"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod etf_service_server {
    ...
    impl<T: EtfService> tonic::server::NamedService for EtfServiceServer<T> {
        const NAME: &'static str = "master_sync.v1.etf.EtfService";
    }
}
