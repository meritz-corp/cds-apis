...
impl<'de> serde::Deserialize<'de> for GetOrderChainRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetOrderChainRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.order_log.GetOrderChainRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetOrderChainRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut order_id__ = None;
        ...
        deserializer.deserialize_struct("kdo.v1.order_log.GetOrderChainRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetOrderChainResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.order_log.GetOrderChainResponse", len)?;
        if true {
...
impl<'de> serde::Deserialize<'de> for GetOrderChainResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetOrderChainResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.order_log.GetOrderChainResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetOrderChainResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(GetOrderChainResponse {
                    order_logs: order_logs__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("kdo.v1.order_log.GetOrderChainResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for LegFillSummary {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.order_log.LegFillSummary", len)?;
        if true {
            struct_ser.serialize_field("fund_code", &self.fund_code)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for LegFillSummary {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = LegFillSummary;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.order_log.LegFillSummary")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<LegFillSummary, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut fund_code__ = None;
...
impl serde::Serialize for ListQuickOrderFillsRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.order_log.ListQuickOrderFillsRequest", len)?;
        if let Some(v) = self.page_size.as_ref() {
            struct_ser.serialize_field("page_size", v)?;
        }
        if let Some(v) = self.page_token.as_ref() {
...
impl<'de> serde::Deserialize<'de> for ListQuickOrderFillsRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListQuickOrderFillsRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.order_log.ListQuickOrderFillsRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListQuickOrderFillsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut page_size__ = None;
        ...
        deserializer.deserialize_struct("kdo.v1.order_log.ListQuickOrderFillsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListQuickOrderFillsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.order_log.ListQuickOrderFillsResponse", len)?;
        if true {
            struct_ser.serialize_field("fills", &self.fills)?;
        }
        if true {
            struct_ser.serialize_field("next_page_token", &self.next_page_token)?;
        }
...
impl<'de> serde::Deserialize<'de> for ListQuickOrderFillsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListQuickOrderFillsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.order_log.ListQuickOrderFillsResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListQuickOrderFillsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut fills__ = None;
                let mut next_page_token__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Fills => {
                            if fills__.is_some() {
                                return Err(serde::de::Error::duplicate_field("fills"));
                            }
                            fills__ = Some(map_.next_value()?);
                        }
                        GeneratedField::NextPageToken => {
                            if next_page_token__.is_some() {
                                return Err(serde::de::Error::duplicate_field("nextPageToken"));
                ...
                Ok(ListQuickOrderFillsResponse {
                    fills: fills__.unwrap_or_default(),
                    next_page_token: next_page_token__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("kdo.v1.order_log.ListQuickOrderFillsResponse", FIELDS, GeneratedVisitor)
    }
}
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::UserArea => {
                            if user_area__.is_some() {
                                return Err(serde::de::Error::duplicate_field("userArea"));
                            }
...
impl serde::Serialize for PairFillSummary {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.order_log.PairFillSummary", len)?;
...
impl<'de> serde::Deserialize<'de> for PairFillSummary {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PairFillSummary;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.order_log.PairFillSummary")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PairFillSummary, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("kdo.v1.order_log.PairFillSummary", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SideFillSummary {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.order_log.SideFillSummary", len)?;
        if true {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("fill_count", ToString::to_string(&self.fill_count).as_str())?;
        }
        if true {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
        ...
        if true {
            struct_ser.serialize_field("avg_price", &self.avg_price)?;
        }
        if true {
        ...
        if true {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("last_exchange_time", ToString::to_string(&self.last_exchange_time).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for SideFillSummary {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "filledQuantity" | "filled_quantity" => Ok(GeneratedField::FilledQuantity),
                            "avgPrice" | "avg_price" => Ok(GeneratedField::AvgPrice),
                            "amount" => Ok(GeneratedField::Amount),
                            "lastExchangeTime" | "last_exchange_time" => Ok(GeneratedField::LastExchangeTime),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SideFillSummary;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.order_log.SideFillSummary")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SideFillSummary, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut fill_count__ = None;
                let mut filled_quantity__ = None;
                let mut avg_price__ = None;
                let mut amount__ = None;
                let mut last_exchange_time__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::AvgPrice => {
                            if avg_price__.is_some() {
                                return Err(serde::de::Error::duplicate_field("avgPrice"));
                            }
                            avg_price__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        ...
                        GeneratedField::LastExchangeTime => {
                            if last_exchange_time__.is_some() {
                                return Err(serde::de::Error::duplicate_field("lastExchangeTime"));
                            }
                            last_exchange_time__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
                        GeneratedField::__SkipField__ => {
                ...
                Ok(SideFillSummary {
                    ...
                    avg_price: avg_price__.unwrap_or_default(),
                    amount: amount__.unwrap_or_default(),
                    last_exchange_time: last_exchange_time__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("kdo.v1.order_log.SideFillSummary", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StreamHedgePairDetailRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for StreamHedgePairDetailRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = StreamHedgePairDetailRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.order_log.StreamHedgePairDetailRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<StreamHedgePairDetailRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut symbol__ = None;
        ...
        deserializer.deserialize_struct("kdo.v1.order_log.StreamHedgePairDetailRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StreamPairFillSummaryRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.order_log.StreamPairFillSummaryRequest", len)?;
        if true {
            struct_ser.serialize_field("quote_fund_code", &self.quote_fund_code)?;
        }
        if true {
            struct_ser.serialize_field("quote_symbol", &self.quote_symbol)?;
        }
...
impl<'de> serde::Deserialize<'de> for StreamPairFillSummaryRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "quoteFundCode" | "quote_fund_code" => Ok(GeneratedField::QuoteFundCode),
                            "quoteSymbol" | "quote_symbol" => Ok(GeneratedField::QuoteSymbol),
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = StreamPairFillSummaryRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.order_log.StreamPairFillSummaryRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<StreamPairFillSummaryRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut quote_fund_code__ = None;
                let mut quote_symbol__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::QuoteFundCode => {
                            if quote_fund_code__.is_some() {
                                return Err(serde::de::Error::duplicate_field("quoteFundCode"));
                            }
                            quote_fund_code__ = Some(map_.next_value()?);
                        }
                        GeneratedField::QuoteSymbol => {
                            if quote_symbol__.is_some() {
                                return Err(serde::de::Error::duplicate_field("quoteSymbol"));
                ...
                Ok(StreamPairFillSummaryRequest {
                    quote_fund_code: quote_fund_code__.unwrap_or_default(),
                    quote_symbol: quote_symbol__.unwrap_or_default(),
        ...
        deserializer.deserialize_struct("kdo.v1.order_log.StreamPairFillSummaryRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StreamQuickOrderFillsRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.order_log.StreamQuickOrderFillsRequest", len)?;
        if true {
            struct_ser.serialize_field("filter", &self.filter)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for StreamQuickOrderFillsRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = StreamQuickOrderFillsRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.order_log.StreamQuickOrderFillsRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<StreamQuickOrderFillsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut filter__ = None;
                ...
                Ok(StreamQuickOrderFillsRequest {
                    filter: filter__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("kdo.v1.order_log.StreamQuickOrderFillsRequest", FIELDS, GeneratedVisitor)
    }
}
