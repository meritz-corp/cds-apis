...
pub mod etf_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("mmm.v1.etf.EtfService", "GetETFManager"));
...
pub mod etf_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/mmm.v1.etf.EtfService/GetETFManager" => {
                    ...
                    struct GetETFManagerSvc<T: EtfService>(pub Arc<T>);
                    impl<T: EtfService> tonic::server::UnaryService<super::CodeRequest>
                    for GetETFManagerSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as EtfService>::get_etf_manager(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: EtfService> tonic::server::NamedService for EtfServiceServer<T> {
        const NAME: &'static str = "mmm.v1.etf.EtfService";
    }
}
