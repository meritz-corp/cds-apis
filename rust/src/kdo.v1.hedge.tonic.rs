...
pub mod hedge_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn update_hedge_accumulator_filled_quantities(
            &mut self,
            request: impl tonic::IntoRequest<
                super::UpdateHedgeAccumulatorFilledQuantitiesRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::HedgeAccumulatorState>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn update_hedge_symbol(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateHedgeSymbolRequest>,
        ) -> std::result::Result<tonic::Response<super::Hedge>, tonic::Status> {
            self.inner
                .ready()
                .await
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.hedge.HedgeService", "UpdateHedgeSymbol"),
                );
            self.inner.unary(req, path, codec).await
        }
...
pub mod hedge_service_server {
    ...
    pub trait HedgeService: Send + Sync + 'static {
        ...
        async fn stream_hedge_accumulators(
            ...
            tonic::Status,
        >;
        async fn update_hedge_accumulator_filled_quantities(
            &self,
            request: tonic::Request<super::UpdateHedgeAccumulatorFilledQuantitiesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::HedgeAccumulatorState>,
            tonic::Status,
        >;
        ...
        async fn update_hedge_symbol(
            &self,
            request: tonic::Request<super::UpdateHedgeSymbolRequest>,
        ) -> std::result::Result<tonic::Response<super::Hedge>, tonic::Status>;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/kdo.v1.hedge.HedgeService/UpdateHedgeAccumulatorFilledQuantities" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateHedgeAccumulatorFilledQuantitiesSvc<T: HedgeService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: HedgeService,
                    > tonic::server::UnaryService<
                        super::UpdateHedgeAccumulatorFilledQuantitiesRequest,
                    > for UpdateHedgeAccumulatorFilledQuantitiesSvc<T> {
                        type Response = super::HedgeAccumulatorState;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as HedgeService>::update_hedge_accumulator_filled_quantities(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateHedgeAccumulatorFilledQuantitiesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.hedge.HedgeService/UpdateHedgeSymbol" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateHedgeSymbolSvc<T: HedgeService>(pub Arc<T>);
                    impl<
                        T: HedgeService,
                    > tonic::server::UnaryService<super::UpdateHedgeSymbolRequest>
                    for UpdateHedgeSymbolSvc<T> {
                        type Response = super::Hedge;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as HedgeService>::update_hedge_symbol(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateHedgeSymbolSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
