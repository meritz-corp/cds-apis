...
impl serde::Serialize for ConstituentPrice {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.lp.ConstituentPrice", len)?;
        if !self.last_price.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ConstituentPrice {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.lp.ConstituentPrice")
            }
        ...
        deserializer.deserialize_struct("kdo.v1.lp.ConstituentPrice", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for Etf {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.lp.Etf", len)?;
        if self.id != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for Etf {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.lp.Etf")
            }
        ...
        deserializer.deserialize_struct("kdo.v1.lp.Etf", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for EtfNav {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.lp.EtfNav", len)?;
...
impl<'de> serde::Deserialize<'de> for EtfNav {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.lp.EtfNav")
            }
...
;
        ...
        deserializer.deserialize_struct("kdo.v1.lp.EtfNav", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EtfPdfConstituent {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.lp.EtfPdfConstituent", len)?;
        if !self.code.is_empty() {
...
impl<'de> serde::Deserialize<'de> for EtfPdfConstituent {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.lp.EtfPdfConstituent")
            }
        ...
        deserializer.deserialize_struct("kdo.v1.lp.EtfPdfConstituent", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FuturesBasedNav {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.lp.FuturesBasedNav", len)?;
        if !self.last_nav.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FuturesBasedNav {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.lp.FuturesBasedNav")
            }
        ...
        deserializer.deserialize_struct("kdo.v1.lp.FuturesBasedNav", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for PhysicalNav {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("kdo.v1.lp.PhysicalNav", len)?;
        if !self.last_nav.is_empty() {
            struct_ser.serialize_field("lastNav", &self.last_nav)?;
        }
        if !self.constituents.is_empty() {
...
impl<'de> serde::Deserialize<'de> for PhysicalNav {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct kdo.v1.lp.PhysicalNav")
            }
        ...
        deserializer.deserialize_struct("kdo.v1.lp.PhysicalNav", FIELDS, GeneratedVisitor)
    }
}
