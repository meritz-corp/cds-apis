...
pub mod pair_v2_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn launch_pair_v2_once(
            &mut self,
            request: impl tonic::IntoRequest<super::LaunchPairV2OnceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::LaunchPairV2OnceResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.pair_v2.PairV2Service", "LaunchPairV2Once"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn cancel_pair_v2_residual(
            &mut self,
            request: impl tonic::IntoRequest<super::CancelPairV2ResidualRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CancelPairV2ResidualResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn amend_pair_v2_residual_pct(
            &mut self,
            request: impl tonic::IntoRequest<super::AmendPairV2ResidualPctRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AmendPairV2ResidualPctResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn list_pair_v2_orders(
            &mut self,
            request: impl tonic::IntoRequest<super::ListPairV2OrdersRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListPairV2OrdersResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.pair_v2.PairV2Service", "ListPairV2Orders"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_pair_v2_order_summary(
            &mut self,
        ...
        pub async fn reset_pair_v2_session(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.pair_v2.PairV2Service", "ResetPairV2Session"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod pair_v2_service_server {
    ...
    pub trait PairV2Service: Send + Sync + 'static {
        ...
        async fn stream_pair_v2_status(
            ...
            tonic::Status,
        >;
        async fn launch_pair_v2_once(
            &self,
            request: tonic::Request<super::LaunchPairV2OnceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::LaunchPairV2OnceResponse>,
            tonic::Status,
        >;
        async fn cancel_pair_v2_residual(
            &self,
            request: tonic::Request<super::CancelPairV2ResidualRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CancelPairV2ResidualResponse>,
            tonic::Status,
        >;
        async fn amend_pair_v2_residual_pct(
            &self,
            request: tonic::Request<super::AmendPairV2ResidualPctRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AmendPairV2ResidualPctResponse>,
            tonic::Status,
        >;
        async fn list_pair_v2_orders(
            &self,
            ...
            tonic::Status,
        >;
        async fn get_pair_v2_order_summary(
            &self,
        ...
        async fn reset_pair_v2_session(
            &self,
            request: tonic::Request<super::ResetPairV2SessionRequest>,
        ) -> std::result::Result<tonic::Response<super::PairV2>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/kdo.v1.pair_v2.PairV2Service/LaunchPairV2Once" => {
                    #[allow(non_camel_case_types)]
                    struct LaunchPairV2OnceSvc<T: PairV2Service>(pub Arc<T>);
                    impl<
                        T: PairV2Service,
                    > tonic::server::UnaryService<super::LaunchPairV2OnceRequest>
                    for LaunchPairV2OnceSvc<T> {
                        type Response = super::LaunchPairV2OnceResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PairV2Service>::launch_pair_v2_once(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = LaunchPairV2OnceSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.pair_v2.PairV2Service/CancelPairV2Residual" => {
                    #[allow(non_camel_case_types)]
                    struct CancelPairV2ResidualSvc<T: PairV2Service>(pub Arc<T>);
                    impl<
                        T: PairV2Service,
                    > tonic::server::UnaryService<super::CancelPairV2ResidualRequest>
                    for CancelPairV2ResidualSvc<T> {
                        type Response = super::CancelPairV2ResidualResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PairV2Service>::cancel_pair_v2_residual(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CancelPairV2ResidualSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.pair_v2.PairV2Service/AmendPairV2ResidualPct" => {
                    #[allow(non_camel_case_types)]
                    struct AmendPairV2ResidualPctSvc<T: PairV2Service>(pub Arc<T>);
                    impl<
                        T: PairV2Service,
                    > tonic::server::UnaryService<super::AmendPairV2ResidualPctRequest>
                    for AmendPairV2ResidualPctSvc<T> {
                        type Response = super::AmendPairV2ResidualPctResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PairV2Service>::amend_pair_v2_residual_pct(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = AmendPairV2ResidualPctSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.pair_v2.PairV2Service/ListPairV2Orders" => {
                    #[allow(non_camel_case_types)]
                    struct ListPairV2OrdersSvc<T: PairV2Service>(pub Arc<T>);
                    impl<
                        T: PairV2Service,
                    > tonic::server::UnaryService<super::ListPairV2OrdersRequest>
                    for ListPairV2OrdersSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PairV2Service>::list_pair_v2_orders(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListPairV2OrdersSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.pair_v2.PairV2Service/GetPairV2OrderSummary" => {
                    #[allow(non_camel_case_types)]
                    struct GetPairV2OrderSummarySvc<T: PairV2Service>(pub Arc<T>);
                    impl<
                        T: PairV2Service,
                    > tonic::server::UnaryService<super::GetPairV2OrderSummaryRequest>
                    for GetPairV2OrderSummarySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PairV2Service>::get_pair_v2_order_summary(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetPairV2OrderSummarySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.pair_v2.PairV2Service/ResetPairV2Session" => {
                    #[allow(non_camel_case_types)]
                    struct ResetPairV2SessionSvc<T: PairV2Service>(pub Arc<T>);
                    impl<
                        T: PairV2Service,
                    > tonic::server::UnaryService<super::ResetPairV2SessionRequest>
                    for ResetPairV2SessionSvc<T> {
                        type Response = super::PairV2;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PairV2Service>::reset_pair_v2_session(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ResetPairV2SessionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
