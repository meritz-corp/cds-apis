...
pub mod market_making_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_constituent_momentum(
            &mut self,
            request: impl tonic::IntoRequest<super::GetConstituentMomentumRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetConstituentMomentumResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn list_mm_pnl_history(
            &mut self,
            request: impl tonic::IntoRequest<super::ListMmPnlHistoryRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.mm.MarketMakingService", "ListMmPnlHistory"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn list_mm_fill_history(
            &mut self,
            request: impl tonic::IntoRequest<super::ListMmFillHistoryRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListMmFillHistoryResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/kdo.v1.mm.MarketMakingService/ListMmFillHistory",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.mm.MarketMakingService", "ListMmFillHistory"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn save_mm_preset(
            &mut self,
            request: impl tonic::IntoRequest<super::SaveMmPresetRequest>,
        ) -> std::result::Result<tonic::Response<super::MmPreset>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.mm.MarketMakingService", "SaveMmPreset"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn list_mm_presets(
            &mut self,
            request: impl tonic::IntoRequest<super::ListMmPresetsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListMmPresetsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.mm.MarketMakingService", "ListMmPresets"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn apply_mm_preset(
            &mut self,
            request: impl tonic::IntoRequest<super::ApplyMmPresetRequest>,
        ) -> std::result::Result<tonic::Response<super::MarketMaking>, tonic::Status> {
            self.inner
                .ready()
                .await
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.mm.MarketMakingService", "ApplyMmPreset"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete_mm_preset(
            &mut self,
            request: impl tonic::IntoRequest<super::DeleteMmPresetRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeleteMmPresetResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.mm.MarketMakingService", "DeleteMmPreset"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn list_mm_config_history(
            &mut self,
            request: impl tonic::IntoRequest<super::ListMmConfigHistoryRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListMmConfigHistoryResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod market_making_service_server {
    ...
    pub trait MarketMakingService: Send + Sync + 'static {
        ...
        async fn get_market_making_orderbook(
            ...
            tonic::Status,
        >;
        async fn get_constituent_momentum(
            &self,
            request: tonic::Request<super::GetConstituentMomentumRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetConstituentMomentumResponse>,
            tonic::Status,
        >;
        ...
        async fn list_mm_daily_pnl(
            ...
            tonic::Status,
        >;
        async fn list_mm_fill_history(
            &self,
            request: tonic::Request<super::ListMmFillHistoryRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListMmFillHistoryResponse>,
            tonic::Status,
        >;
        async fn fit_to_market(
            ...
            tonic::Status,
        >;
        async fn save_mm_preset(
            &self,
            request: tonic::Request<super::SaveMmPresetRequest>,
        ) -> std::result::Result<tonic::Response<super::MmPreset>, tonic::Status>;
        async fn list_mm_presets(
            &self,
            request: tonic::Request<super::ListMmPresetsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListMmPresetsResponse>,
            tonic::Status,
        >;
        async fn apply_mm_preset(
            &self,
            request: tonic::Request<super::ApplyMmPresetRequest>,
        ) -> std::result::Result<tonic::Response<super::MarketMaking>, tonic::Status>;
        async fn delete_mm_preset(
            &self,
            request: tonic::Request<super::DeleteMmPresetRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeleteMmPresetResponse>,
            tonic::Status,
        >;
        async fn list_mm_config_history(
            &self,
            request: tonic::Request<super::ListMmConfigHistoryRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListMmConfigHistoryResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/kdo.v1.mm.MarketMakingService/GetConstituentMomentum" => {
                    #[allow(non_camel_case_types)]
                    struct GetConstituentMomentumSvc<T: MarketMakingService>(pub Arc<T>);
                    impl<
                        T: MarketMakingService,
                    > tonic::server::UnaryService<super::GetConstituentMomentumRequest>
                    for GetConstituentMomentumSvc<T> {
                        type Response = super::GetConstituentMomentumResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MarketMakingService>::get_constituent_momentum(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetConstituentMomentumSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.mm.MarketMakingService/ListMmPnlHistory" => {
                    #[allow(non_camel_case_types)]
                    struct ListMmPnlHistorySvc<T: MarketMakingService>(pub Arc<T>);
                    impl<
                        T: MarketMakingService,
                    > tonic::server::UnaryService<super::ListMmPnlHistoryRequest>
                    for ListMmPnlHistorySvc<T> {
                        type Response = super::ListMmPnlHistoryResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MarketMakingService>::list_mm_pnl_history(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/kdo.v1.mm.MarketMakingService/ListMmFillHistory" => {
                    #[allow(non_camel_case_types)]
                    struct ListMmFillHistorySvc<T: MarketMakingService>(pub Arc<T>);
                    impl<
                        T: MarketMakingService,
                    > tonic::server::UnaryService<super::ListMmFillHistoryRequest>
                    for ListMmFillHistorySvc<T> {
                        type Response = super::ListMmFillHistoryResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MarketMakingService>::list_mm_fill_history(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListMmFillHistorySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.mm.MarketMakingService/SaveMmPreset" => {
                    #[allow(non_camel_case_types)]
                    struct SaveMmPresetSvc<T: MarketMakingService>(pub Arc<T>);
                    impl<
                        T: MarketMakingService,
                    > tonic::server::UnaryService<super::SaveMmPresetRequest>
                    for SaveMmPresetSvc<T> {
                        type Response = super::MmPreset;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MarketMakingService>::save_mm_preset(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SaveMmPresetSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.mm.MarketMakingService/ListMmPresets" => {
                    #[allow(non_camel_case_types)]
                    struct ListMmPresetsSvc<T: MarketMakingService>(pub Arc<T>);
                    impl<
                        T: MarketMakingService,
                    > tonic::server::UnaryService<super::ListMmPresetsRequest>
                    for ListMmPresetsSvc<T> {
                        type Response = super::ListMmPresetsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MarketMakingService>::list_mm_presets(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListMmPresetsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.mm.MarketMakingService/ApplyMmPreset" => {
                    #[allow(non_camel_case_types)]
                    struct ApplyMmPresetSvc<T: MarketMakingService>(pub Arc<T>);
                    impl<
                        T: MarketMakingService,
                    > tonic::server::UnaryService<super::ApplyMmPresetRequest>
                    for ApplyMmPresetSvc<T> {
                        type Response = super::MarketMaking;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MarketMakingService>::apply_mm_preset(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ApplyMmPresetSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.mm.MarketMakingService/DeleteMmPreset" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteMmPresetSvc<T: MarketMakingService>(pub Arc<T>);
                    impl<
                        T: MarketMakingService,
                    > tonic::server::UnaryService<super::DeleteMmPresetRequest>
                    for DeleteMmPresetSvc<T> {
                        type Response = super::DeleteMmPresetResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MarketMakingService>::delete_mm_preset(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteMmPresetSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.mm.MarketMakingService/ListMmConfigHistory" => {
                    #[allow(non_camel_case_types)]
                    struct ListMmConfigHistorySvc<T: MarketMakingService>(pub Arc<T>);
                    impl<
                        T: MarketMakingService,
                    > tonic::server::UnaryService<super::ListMmConfigHistoryRequest>
                    for ListMmConfigHistorySvc<T> {
                        type Response = super::ListMmConfigHistoryResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MarketMakingService>::list_mm_config_history(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListMmConfigHistorySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
