...
pub mod order_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("kdo.v1.order.OrderService", "SubmitOrder"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn amend_order(
            &mut self,
            request: impl tonic::IntoRequest<super::AmendOrderRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AmendOrderResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("kdo.v1.order.OrderService", "AmendOrder"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("kdo.v1.order.OrderService", "CancelAllOrders"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod order_service_server {
    ...
    pub trait OrderService: Send + Sync + 'static {
        ...
        async fn amend_order(
            &self,
            request: tonic::Request<super::AmendOrderRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AmendOrderResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/kdo.v1.order.OrderService/SubmitOrder" => {
                    ...
                    struct SubmitOrderSvc<T: OrderService>(pub Arc<T>);
                    impl<
                        T: OrderService,
                    ...
                    for SubmitOrderSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as OrderService>::submit_order(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/kdo.v1.order.OrderService/AmendOrder" => {
                    #[allow(non_camel_case_types)]
                    struct AmendOrderSvc<T: OrderService>(pub Arc<T>);
                    impl<
                        T: OrderService,
                    > tonic::server::UnaryService<super::AmendOrderRequest>
                    for AmendOrderSvc<T> {
                        type Response = super::AmendOrderResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OrderService>::amend_order(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = AmendOrderSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/kdo.v1.order.OrderService/CancelAllOrders" => {
                    #[allow(non_camel_case_types)]
                    struct CancelAllOrdersSvc<T: OrderService>(pub Arc<T>);
                    impl<
                        T: OrderService,
                    ...
                    for CancelAllOrdersSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OrderService>::cancel_all_orders(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T: OrderService> tonic::server::NamedService for OrderServiceServer<T> {
        const NAME: &'static str = "kdo.v1.order.OrderService";
    }
}
