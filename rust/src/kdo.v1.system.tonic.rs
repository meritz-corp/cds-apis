...
pub mod system_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.system.SystemService", "GetConnectionInfo"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_version_info(
            &mut self,
            request: impl tonic::IntoRequest<super::GetVersionInfoRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.system.SystemService", "GetVersionInfo"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn stop_symbol_fund(
            &mut self,
            request: impl tonic::IntoRequest<super::StopSymbolFundRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("kdo.v1.system.SystemService", "StopSymbolFund"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod system_service_server {
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/kdo.v1.system.SystemService/GetConnectionInfo" => {
                    ...
                    for GetConnectionInfoSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as SystemService>::get_connection_info(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/kdo.v1.system.SystemService/GetVersionInfo" => {
                    #[allow(non_camel_case_types)]
                    struct GetVersionInfoSvc<T: SystemService>(pub Arc<T>);
                    impl<
                        T: SystemService,
                    > tonic::server::UnaryService<super::GetVersionInfoRequest>
                    for GetVersionInfoSvc<T> {
                        type Response = super::GetVersionInfoResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SystemService>::get_version_info(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/kdo.v1.system.SystemService/StopSymbolFund" => {
                    #[allow(non_camel_case_types)]
                    struct StopSymbolFundSvc<T: SystemService>(pub Arc<T>);
                    impl<
                        T: SystemService,
                    > tonic::server::UnaryService<super::StopSymbolFundRequest>
                    for StopSymbolFundSvc<T> {
                        type Response = super::StopSymbolFundResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SystemService>::stop_symbol_fund(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T: SystemService> tonic::server::NamedService for SystemServiceServer<T> {
        const NAME: &'static str = "kdo.v1.system.SystemService";
    }
}
