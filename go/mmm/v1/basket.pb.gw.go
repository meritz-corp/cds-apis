...
func request_BasketService_AddBasketPreset_0(ctx context.Context, marshaler runtime.Marshaler, client BasketServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_BasketService_AddBasketPreset_0(ctx context.Context, marshaler runtime.Marshaler, server BasketServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AddBasketPresetRequest
	var metadata runtime.ServerMetadata
...
func request_BasketService_CreateBasketManagerFromPreset_0(ctx context.Context, marshaler runtime.Marshaler, client BasketServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_BasketService_CreateBasketManagerFromPreset_0(ctx context.Context, marshaler runtime.Marshaler, server BasketServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ControlManagerRequest
	var metadata runtime.ServerMetadata
...
func RegisterBasketServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BasketServiceServer) error {
	...
	mux.Handle("POST", pattern_BasketService_AddBasketPreset_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_BasketService_AddBasketPreset_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_BasketService_AddBasketPreset_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_BasketService_CreateBasketManagerFromPreset_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_BasketService_CreateBasketManagerFromPreset_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_BasketService_CreateBasketManagerFromPreset_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterBasketServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BasketServiceClient) error {
	...
	mux.Handle("POST", pattern_BasketService_AddBasketPreset_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_BasketService_AddBasketPreset_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_BasketService_CreateBasketManagerFromPreset_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_BasketService_CreateBasketManagerFromPreset_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	forward_BasketService_AddBasketPreset_0 = runtime.ForwardResponseMessage

	forward_BasketService_CreateBasketManagerFromPreset_0 = runtime.ForwardResponseMessage
)
