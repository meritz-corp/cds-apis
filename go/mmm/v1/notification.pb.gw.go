...
func RegisterNotificationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NotificationServiceServer) error {
	...
	mux.Handle("POST", pattern_NotificationService_CreateNotification_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mmm.v1.notification.NotificationService/CreateNotification", runtime.WithHTTPPathPattern("/mmm.v1.notification.NotificationService/CreateNotification"))
		if err != nil {
...
func RegisterNotificationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client NotificationServiceClient) error {
	...
	mux.Handle("POST", pattern_NotificationService_CreateNotification_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mmm.v1.notification.NotificationService/CreateNotification", runtime.WithHTTPPathPattern("/mmm.v1.notification.NotificationService/CreateNotification"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_NotificationService_CreateNotification_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"mmm.v1.notification.NotificationService", "CreateNotification"}, ""))
)
