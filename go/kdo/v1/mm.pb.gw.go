...
func request_MarketMakingService_ClearFitToMarket_0(ctx context.Context, marshaler runtime.Marshaler, client MarketMakingServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ClearFitToMarketRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ClearFitToMarket(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_MarketMakingService_ClearFitToMarket_0(ctx context.Context, marshaler runtime.Marshaler, server MarketMakingServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ClearFitToMarketRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ClearFitToMarket(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterMarketMakingServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MarketMakingServiceServer) error {
	...
	mux.Handle("POST", pattern_MarketMakingService_ClearFitToMarket_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/kdo.v1.mm.MarketMakingService/ClearFitToMarket", runtime.WithHTTPPathPattern("/v1/mm/{symbol=*}:clearFitToMarket"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_MarketMakingService_ClearFitToMarket_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_MarketMakingService_ClearFitToMarket_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterMarketMakingServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MarketMakingServiceClient) error {
	...
	mux.Handle("POST", pattern_MarketMakingService_ClearFitToMarket_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/kdo.v1.mm.MarketMakingService/ClearFitToMarket", runtime.WithHTTPPathPattern("/v1/mm/{symbol=*}:clearFitToMarket"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_MarketMakingService_ClearFitToMarket_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	forward_MarketMakingService_ClearFitToMarket_0 = runtime.ForwardResponseMessage
)
