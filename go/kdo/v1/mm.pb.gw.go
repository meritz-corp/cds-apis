...
func request_MarketMakingService_GetMmEngineConfig_0(ctx context.Context, marshaler runtime.Marshaler, client MarketMakingServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetMmEngineConfigRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetMmEngineConfig(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_MarketMakingService_GetMmEngineConfig_0(ctx context.Context, marshaler runtime.Marshaler, server MarketMakingServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetMmEngineConfigRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetMmEngineConfig(ctx, &protoReq)
	return msg, metadata, err

}

func request_MarketMakingService_UpdateMmEngineConfig_0(ctx context.Context, marshaler runtime.Marshaler, client MarketMakingServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateMmEngineConfigRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.UpdateMmEngineConfig(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_MarketMakingService_UpdateMmEngineConfig_0(ctx context.Context, marshaler runtime.Marshaler, server MarketMakingServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateMmEngineConfigRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UpdateMmEngineConfig(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterMarketMakingServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MarketMakingServiceServer) error {
	...
	mux.Handle("GET", pattern_MarketMakingService_GetMmEngineConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/kdo.v1.mm.MarketMakingService/GetMmEngineConfig", runtime.WithHTTPPathPattern("/v1/mm/{symbol=*}/engine-config"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_MarketMakingService_GetMmEngineConfig_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_MarketMakingService_GetMmEngineConfig_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("PATCH", pattern_MarketMakingService_UpdateMmEngineConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/kdo.v1.mm.MarketMakingService/UpdateMmEngineConfig", runtime.WithHTTPPathPattern("/v1/mm/{symbol=*}/engine-config"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_MarketMakingService_UpdateMmEngineConfig_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_MarketMakingService_UpdateMmEngineConfig_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterMarketMakingServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MarketMakingServiceClient) error {
	...
	mux.Handle("GET", pattern_MarketMakingService_GetMmEngineConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/kdo.v1.mm.MarketMakingService/GetMmEngineConfig", runtime.WithHTTPPathPattern("/v1/mm/{symbol=*}/engine-config"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_MarketMakingService_GetMmEngineConfig_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("PATCH", pattern_MarketMakingService_UpdateMmEngineConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/kdo.v1.mm.MarketMakingService/UpdateMmEngineConfig", runtime.WithHTTPPathPattern("/v1/mm/{symbol=*}/engine-config"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_MarketMakingService_UpdateMmEngineConfig_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_MarketMakingService_GetMmEngineConfig_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "mm", "symbol", "engine-config"}, ""))

	pattern_MarketMakingService_UpdateMmEngineConfig_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "mm", "symbol", "engine-config"}, ""))
...
var (
	...
	forward_MarketMakingService_GetMmEngineConfig_0 = runtime.ForwardResponseMessage

	forward_MarketMakingService_UpdateMmEngineConfig_0 = runtime.ForwardResponseMessage
