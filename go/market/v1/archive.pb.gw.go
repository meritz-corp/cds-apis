...
func RegisterOrderbookServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OrderbookServiceServer) error {
	...
	mux.Handle("POST", pattern_OrderbookService_GetOrderbooks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/market.v1.archive.OrderbookService/GetOrderbooks", runtime.WithHTTPPathPattern("/market.v1.archive.OrderbookService/GetOrderbooks"))
		if err != nil {
	...
	mux.Handle("POST", pattern_OrderbookService_GetLatestOrderbook_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/market.v1.archive.OrderbookService/GetLatestOrderbook", runtime.WithHTTPPathPattern("/market.v1.archive.OrderbookService/GetLatestOrderbook"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_OrderbookService_GetOrderbookSnapshot_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/market.v1.archive.OrderbookService/GetOrderbookSnapshot", runtime.WithHTTPPathPattern("/market.v1.archive.OrderbookService/GetOrderbookSnapshot"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterTradeServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TradeServiceServer) error {
	...
	mux.Handle("POST", pattern_TradeService_GetTrades_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/market.v1.archive.TradeService/GetTrades", runtime.WithHTTPPathPattern("/market.v1.archive.TradeService/GetTrades"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterCandleServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CandleServiceServer) error {
	...
	mux.Handle("POST", pattern_CandleService_GetCandles_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/market.v1.archive.CandleService/GetCandles", runtime.WithHTTPPathPattern("/market.v1.archive.CandleService/GetCandles"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterSymbolServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SymbolServiceServer) error {
	...
	mux.Handle("POST", pattern_SymbolService_ListSymbols_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/market.v1.archive.SymbolService/ListSymbols", runtime.WithHTTPPathPattern("/market.v1.archive.SymbolService/ListSymbols"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SymbolService_GetSymbol_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/market.v1.archive.SymbolService/GetSymbol", runtime.WithHTTPPathPattern("/market.v1.archive.SymbolService/GetSymbol"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterIndicatorServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IndicatorServiceServer) error {
	...
	mux.Handle("POST", pattern_IndicatorService_GetIndicator_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/market.v1.archive.IndicatorService/GetIndicator", runtime.WithHTTPPathPattern("/market.v1.archive.IndicatorService/GetIndicator"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterIngestionServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IngestionServiceServer) error {
	...
	mux.Handle("POST", pattern_IngestionService_IngestFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/market.v1.archive.IngestionService/IngestFile", runtime.WithHTTPPathPattern("/market.v1.archive.IngestionService/IngestFile"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_IngestionService_IngestDirectory_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/market.v1.archive.IngestionService/IngestDirectory", runtime.WithHTTPPathPattern("/market.v1.archive.IngestionService/IngestDirectory"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterOrderbookServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OrderbookServiceClient) error {
	...
	mux.Handle("POST", pattern_OrderbookService_GetOrderbooks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/market.v1.archive.OrderbookService/GetOrderbooks", runtime.WithHTTPPathPattern("/market.v1.archive.OrderbookService/GetOrderbooks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_OrderbookService_GetLatestOrderbook_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/market.v1.archive.OrderbookService/GetLatestOrderbook", runtime.WithHTTPPathPattern("/market.v1.archive.OrderbookService/GetLatestOrderbook"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_OrderbookService_GetOrderbookSnapshot_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/market.v1.archive.OrderbookService/GetOrderbookSnapshot", runtime.WithHTTPPathPattern("/market.v1.archive.OrderbookService/GetOrderbookSnapshot"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_OrderbookService_SubscribeOrderbooks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/market.v1.archive.OrderbookService/SubscribeOrderbooks", runtime.WithHTTPPathPattern("/market.v1.archive.OrderbookService/SubscribeOrderbooks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_OrderbookService_GetOrderbooks_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"market.v1.archive.OrderbookService", "GetOrderbooks"}, ""))

	pattern_OrderbookService_GetLatestOrderbook_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"market.v1.archive.OrderbookService", "GetLatestOrderbook"}, ""))

	pattern_OrderbookService_GetOrderbookSnapshot_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"market.v1.archive.OrderbookService", "GetOrderbookSnapshot"}, ""))

	pattern_OrderbookService_SubscribeOrderbooks_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"market.v1.archive.OrderbookService", "SubscribeOrderbooks"}, ""))
)
...
func RegisterTradeServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TradeServiceClient) error {
	...
	mux.Handle("POST", pattern_TradeService_GetTrades_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/market.v1.archive.TradeService/GetTrades", runtime.WithHTTPPathPattern("/market.v1.archive.TradeService/GetTrades"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_TradeService_SubscribeTrades_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/market.v1.archive.TradeService/SubscribeTrades", runtime.WithHTTPPathPattern("/market.v1.archive.TradeService/SubscribeTrades"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_TradeService_GetTrades_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"market.v1.archive.TradeService", "GetTrades"}, ""))

	pattern_TradeService_SubscribeTrades_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"market.v1.archive.TradeService", "SubscribeTrades"}, ""))
)
...
func RegisterCandleServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CandleServiceClient) error {
	...
	mux.Handle("POST", pattern_CandleService_GetCandles_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/market.v1.archive.CandleService/GetCandles", runtime.WithHTTPPathPattern("/market.v1.archive.CandleService/GetCandles"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_CandleService_SubscribeCandles_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/market.v1.archive.CandleService/SubscribeCandles", runtime.WithHTTPPathPattern("/market.v1.archive.CandleService/SubscribeCandles"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_CandleService_GetCandles_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"market.v1.archive.CandleService", "GetCandles"}, ""))

	pattern_CandleService_SubscribeCandles_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"market.v1.archive.CandleService", "SubscribeCandles"}, ""))
)
...
func RegisterSymbolServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SymbolServiceClient) error {
	...
	mux.Handle("POST", pattern_SymbolService_ListSymbols_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/market.v1.archive.SymbolService/ListSymbols", runtime.WithHTTPPathPattern("/market.v1.archive.SymbolService/ListSymbols"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SymbolService_GetSymbol_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/market.v1.archive.SymbolService/GetSymbol", runtime.WithHTTPPathPattern("/market.v1.archive.SymbolService/GetSymbol"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_SymbolService_ListSymbols_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"market.v1.archive.SymbolService", "ListSymbols"}, ""))

	pattern_SymbolService_GetSymbol_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"market.v1.archive.SymbolService", "GetSymbol"}, ""))
)
...
func RegisterIndicatorServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client IndicatorServiceClient) error {
	...
	mux.Handle("POST", pattern_IndicatorService_GetIndicator_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/market.v1.archive.IndicatorService/GetIndicator", runtime.WithHTTPPathPattern("/market.v1.archive.IndicatorService/GetIndicator"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_IndicatorService_GetIndicator_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"market.v1.archive.IndicatorService", "GetIndicator"}, ""))
)
...
func RegisterIngestionServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client IngestionServiceClient) error {
	...
	mux.Handle("POST", pattern_IngestionService_IngestFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/market.v1.archive.IngestionService/IngestFile", runtime.WithHTTPPathPattern("/market.v1.archive.IngestionService/IngestFile"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_IngestionService_IngestDirectory_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/market.v1.archive.IngestionService/IngestDirectory", runtime.WithHTTPPathPattern("/market.v1.archive.IngestionService/IngestDirectory"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_IngestionService_IngestFile_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"market.v1.archive.IngestionService", "IngestFile"}, ""))

	pattern_IngestionService_IngestDirectory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"market.v1.archive.IngestionService", "IngestDirectory"}, ""))
)
