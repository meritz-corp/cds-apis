...
@$core.Deprecated('Use momentumConfigDescriptor instead')
const MomentumConfig$json = {
  '1': 'MomentumConfig',
  '2': [
    {'1': 'enabled', '3': 1, '4': 1, '5': 8, '10': 'enabled'},
    {'1': 'window_ms', '3': 2, '4': 1, '5': 4, '10': 'windowMs'},
...
/// Descriptor for `MomentumConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List momentumConfigDescriptor = $convert.base64Decode(
    'Cg5Nb21lbnR1bUNvbmZpZxIYCgdlbmFibGVkGAEgASgIUgdlbmFibGVkEhsKCXdpbmRvd19tcx'
    'gCIAEoBFIId2luZG93TXMSIwoNdHJpZ2dlcl90aWNrcxgDIAEoBVIMdHJpZ2dlclRpY2tzEi0K'
    'EmZvbGxvd19zZW5zaXRpdml0eRgEIAEoAVIRZm9sbG93U2Vuc2l0aXZpdHkSLQoSZXNjYXBlX3'
    'NlbnNpdGl2aXR5GAUgASgBUhFlc2NhcGVTZW5zaXRpdml0eRIoChBtYXhfZm9sbG93X3RpY2tz'
    'GAYgASgFUg5tYXhGb2xsb3dUaWNrcxIoChBtYXhfZXNjYXBlX3RpY2tzGAcgASgFUg5tYXhFc2'
    'NhcGVUaWNrcxIfCgtpc19vcHBvc2l0ZRgIIAEoCFIKaXNPcHBvc2l0ZQ==');

@$core.Deprecated('Use skewConfigDescriptor instead')
const SkewConfig$json = {
  '1': 'SkewConfig',
  '2': [
    {'1': 'mode', '3': 1, '4': 1, '5': 9, '10': 'mode'},
    {'1': 'trigger_amt', '3': 2, '4': 1, '5': 3, '10': 'triggerAmt'},
...
/// Descriptor for `SkewConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List skewConfigDescriptor = $convert.base64Decode(
    'CgpTa2V3Q29uZmlnEhIKBG1vZGUYASABKAlSBG1vZGUSHwoLdHJpZ2dlcl9hbXQYAiABKANSCn'
    'RyaWdnZXJBbXQSGwoJc2tld191bml0GAMgASgFUghza2V3VW5pdA==');

@$core.Deprecated('Use tradeAnalyzerConfigDescriptor instead')
const TradeAnalyzerConfig$json = {
  '1': 'TradeAnalyzerConfig',
  '2': [
    {'1': 'enabled', '3': 1, '4': 1, '5': 8, '10': 'enabled'},
    {'1': 'window', '3': 2, '4': 1, '5': 5, '10': 'window'},
    {'1': 'ratio_threshold', '3': 3, '4': 1, '5': 1, '10': 'ratioThreshold'},
    {'1': 'strength_threshold', '3': 4, '4': 1, '5': 1, '10': 'strengthThreshold'},
    {'1': 'max_deco_tick', '3': 5, '4': 1, '5': 5, '10': 'maxDecoTick'},
  ],
...
/// Descriptor for `TradeAnalyzerConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tradeAnalyzerConfigDescriptor = $convert.base64Decode(
    'ChNUcmFkZUFuYWx5emVyQ29uZmlnEhgKB2VuYWJsZWQYASABKAhSB2VuYWJsZWQSFgoGd2luZG'
    '93GAIgASgFUgZ3aW5kb3cSJwoPcmF0aW9fdGhyZXNob2xkGAMgASgBUg5yYXRpb1RocmVzaG9s'
    'ZBItChJzdHJlbmd0aF90aHJlc2hvbGQYBCABKAFSEXN0cmVuZ3RoVGhyZXNob2xkEiIKDW1heF'
    '9kZWNvX3RpY2sYBSABKAVSC21heERlY29UaWNr');

@$core.Deprecated('Use exposureGuardConfigDescriptor instead')
const ExposureGuardConfig$json = {
  '1': 'ExposureGuardConfig',
  '2': [
    {'1': 'enabled', '3': 1, '4': 1, '5': 8, '10': 'enabled'},
    {'1': 'reduce_start_multiple', '3': 2, '4': 1, '5': 5, '10': 'reduceStartMultiple'},
    {'1': 'max_inventory_multiple', '3': 3, '4': 1, '5': 5, '10': 'maxInventoryMultiple'},
...
/// Descriptor for `ExposureGuardConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List exposureGuardConfigDescriptor = $convert.base64Decode(
    'ChNFeHBvc3VyZUd1YXJkQ29uZmlnEhgKB2VuYWJsZWQYASABKAhSB2VuYWJsZWQSMgoVcmVkdW'
    'NlX3N0YXJ0X211bHRpcGxlGAIgASgFUhNyZWR1Y2VTdGFydE11bHRpcGxlEjQKFm1heF9pbnZl'
    'bnRvcnlfbXVsdGlwbGUYAyABKAVSFG1heEludmVudG9yeU11bHRpcGxl');

@$core.Deprecated('Use inventoryBalancerConfigDescriptor instead')
const InventoryBalancerConfig$json = {
  '1': 'InventoryBalancerConfig',
  '2': [
    {'1': 'enabled', '3': 1, '4': 1, '5': 8, '10': 'enabled'},
    {'1': 'trigger_multiple', '3': 2, '4': 1, '5': 5, '10': 'triggerMultiple'},
    {'1': 'price_skew_ticks', '3': 3, '4': 1, '5': 5, '10': 'priceSkewTicks'},
...
/// Descriptor for `InventoryBalancerConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List inventoryBalancerConfigDescriptor = $convert.base64Decode(
    'ChdJbnZlbnRvcnlCYWxhbmNlckNvbmZpZxIYCgdlbmFibGVkGAEgASgIUgdlbmFibGVkEikKEH'
    'RyaWdnZXJfbXVsdGlwbGUYAiABKAVSD3RyaWdnZXJNdWx0aXBsZRIoChBwcmljZV9za2V3X3Rp'
    'Y2tzGAMgASgFUg5wcmljZVNrZXdUaWNrcxIuChNzYW1lX3NpZGVfcmVkdWN0aW9uGAQgASgBUh'
    'FzYW1lU2lkZVJlZHVjdGlvbhItChNtaW5fc2FtZV9zaWRlX3NjYWxlGAUgASgBUhBtaW5TYW1l'
    'U2lkZVNjYWxl');

@$core.Deprecated('Use screeningConfigDescriptor instead')
const ScreeningConfig$json = {
  '1': 'ScreeningConfig',
  '2': [
    {'1': 'max_spread_width_ticks', '3': 1, '4': 1, '5': 5, '10': 'maxSpreadWidthTicks'},
  ],
...
/// Descriptor for `ScreeningConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List screeningConfigDescriptor = $convert.base64Decode(
    'Cg9TY3JlZW5pbmdDb25maWcSMwoWbWF4X3NwcmVhZF93aWR0aF90aWNrcxgBIAEoBVITbWF4U3'
    'ByZWFkV2lkdGhUaWNrcw==');

@$core.Deprecated('Use mmEngineConfigDescriptor instead')
const MmEngineConfig$json = {
  '1': 'MmEngineConfig',
  '2': [
    {'1': 'momentum', '3': 1, '4': 1, '5': 11, '6': '.kdo.v1.mm.MomentumConfig', '10': 'momentum'},
    {'1': 'skew', '3': 2, '4': 1, '5': 11, '6': '.kdo.v1.mm.SkewConfig', '10': 'skew'},
    {'1': 'trade_analyzer', '3': 3, '4': 1, '5': 11, '6': '.kdo.v1.mm.TradeAnalyzerConfig', '10': 'tradeAnalyzer'},
    {'1': 'exposure_guard', '3': 4, '4': 1, '5': 11, '6': '.kdo.v1.mm.ExposureGuardConfig', '10': 'exposureGuard'},
    {'1': 'inventory_balancer', '3': 5, '4': 1, '5': 11, '6': '.kdo.v1.mm.InventoryBalancerConfig', '10': 'inventoryBalancer'},
    {'1': 'screening', '3': 6, '4': 1, '5': 11, '6': '.kdo.v1.mm.ScreeningConfig', '10': 'screening'},
  ],
};

/// Descriptor for `MmEngineConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mmEngineConfigDescriptor = $convert.base64Decode(
    'Cg5NbUVuZ2luZUNvbmZpZxI1Cghtb21lbnR1bRgBIAEoCzIZLmtkby52MS5tbS5Nb21lbnR1bU'
    'NvbmZpZ1IIbW9tZW50dW0SKQoEc2tldxgCIAEoCzIVLmtkby52MS5tbS5Ta2V3Q29uZmlnUgRz'
    'a2V3EkUKDnRyYWRlX2FuYWx5emVyGAMgASgLMh4ua2RvLnYxLm1tLlRyYWRlQW5hbHl6ZXJDb2'
    '5maWdSDXRyYWRlQW5hbHl6ZXISRQoOZXhwb3N1cmVfZ3VhcmQYBCABKAsyHi5rZG8udjEubW0u'
    'RXhwb3N1cmVHdWFyZENvbmZpZ1INZXhwb3N1cmVHdWFyZBJRChJpbnZlbnRvcnlfYmFsYW5jZX'
    'IYBSABKAsyIi5rZG8udjEubW0uSW52ZW50b3J5QmFsYW5jZXJDb25maWdSEWludmVudG9yeUJh'
    'bGFuY2VyEjgKCXNjcmVlbmluZxgGIAEoCzIaLmtkby52MS5tbS5TY3JlZW5pbmdDb25maWdSCX'
    'NjcmVlbmluZw==');
...
@$core.Deprecated('Use getMmEngineConfigRequestDescriptor instead')
const GetMmEngineConfigRequest$json = {
  '1': 'GetMmEngineConfigRequest',
  '2': [
    {'1': 'symbol', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'symbol'},
  ],
};

/// Descriptor for `GetMmEngineConfigRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMmEngineConfigRequestDescriptor = $convert.base64Decode(
    'ChhHZXRNbUVuZ2luZUNvbmZpZ1JlcXVlc3QSHAoGc3ltYm9sGAEgASgJQgTiQQECUgZzeW1ib2'
    'w=');

@$core.Deprecated('Use updateMmEngineConfigRequestDescriptor instead')
const UpdateMmEngineConfigRequest$json = {
  '1': 'UpdateMmEngineConfigRequest',
  '2': [
    {'1': 'symbol', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'symbol'},
    {'1': 'config', '3': 2, '4': 1, '5': 11, '6': '.kdo.v1.mm.MmEngineConfig', '8': {}, '10': 'config'},
  ],
};

/// Descriptor for `UpdateMmEngineConfigRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateMmEngineConfigRequestDescriptor = $convert.base64Decode(
    'ChtVcGRhdGVNbUVuZ2luZUNvbmZpZ1JlcXVlc3QSHAoGc3ltYm9sGAEgASgJQgTiQQECUgZzeW'
    '1ib2wSNwoGY29uZmlnGAIgASgLMhkua2RvLnYxLm1tLk1tRW5naW5lQ29uZmlnQgTiQQECUgZj'
    'b25maWc=');
