...
extension type AutoAmendServiceClient (connect.Transport _transport) {
  /// 주문 자동정정 등록
  Future<kdov1auto_amend.AutoAmendOrder> registerOrder(
    kdov1auto_amend.RegisterOrderRequest input, {
    ...
    return connect.Client(_transport).unary(
      specs.AutoAmendService.registerOrder,
      input,
      signal: signal,
      headers: headers,
      onHeader: onHeader,
  ...
  /// 주문 자동정정 해제
  Future<googleprotobufempty.Empty> unregisterOrder(
    kdov1auto_amend.UnregisterOrderRequest input, {
    connect.Headers? headers,
    connect.AbortSignal? signal,
    Function(connect.Headers)? onHeader,
    Function(connect.Headers)? onTrailer,
    ...
    return connect.Client(_transport).unary(
      specs.AutoAmendService.unregisterOrder,
      input,
      signal: signal,
      headers: headers,
      onHeader: onHeader,
  ...
  Future<kdov1auto_amend.AutoAmendOrder> getOrder(
    kdov1auto_amend.GetOrderRequest input, {
    connect.Headers? headers,
    connect.AbortSignal? signal,
    Function(connect.Headers)? onHeader,
    Function(connect.Headers)? onTrailer,
  ...
  /// 등록된 주문 목록 조회
  Future<kdov1auto_amend.ListOrdersResponse> listOrders(
    kdov1auto_amend.ListOrdersRequest input, {
    connect.Headers? headers,
    connect.AbortSignal? signal,
    Function(connect.Headers)? onHeader,
    Function(connect.Headers)? onTrailer,
