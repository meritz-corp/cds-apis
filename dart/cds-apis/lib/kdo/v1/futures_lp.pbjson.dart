...
final $typed_data.Uint8List futuresLpDescriptor = $convert.base64Decode(
    ...
    'bnRpdHlMaW1pdIgBARIfCgtldGZfcHJpY2luZxgUIAEoCVIKZXRmUHJpY2luZ0IRCg9fYmlkX2'
    'FkanVzdG1lbnRCEQoPX2Fza19hZGp1c3RtZW50QhEKD19xdWFudGl0eV9saW1pdEoECAUQBkoE'
    'CBAQEUoECBEQEkoECBIQE1IFY2FycnlSEG1vbWVudHVtX2VuYWJsZWRSD21vbWVudHVtX3dpbm'
    'Rvd1IUbW9tZW50dW1fc2Vuc2l0aXZpdHk=');
...
@$core.Deprecated('Use futuresLpHedgeDescriptor instead')
const FuturesLpHedge$json = {
  '1': 'FuturesLpHedge',
  '2': [
...
/// Descriptor for `FuturesLpHedge`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List futuresLpHedgeDescriptor = $convert.base64Decode(
    'Cg5GdXR1cmVzTHBIZWRnZRIWCgZzeW1ib2wYASABKAlSBnN5bWJvbBItCgRmdW5kGAIgASgJQh'
    'n6QRYKFGtkby5jZHNhcGlzLnh5ei9GdW5kUgRmdW5kEiwKEnF1YW50aXR5X3Blcl9oZWRnZRgD'
    'IAEoCVIQcXVhbnRpdHlQZXJIZWRnZQ==');
...
const FuturesLpStatus$json = {
  ...
  '2': [
    ...
    {'1': 'hedge', '3': 25, '4': 1, '5': 11, '6': '.kdo.v1.futures_lp.FuturesLpHedge', '9': 3, '10': 'hedge', '17': true},
  ],
  '8': [
    {'1': '_bid_adjustment'},
    {'1': '_ask_adjustment'},
...
final $typed_data.Uint8List futuresLpStatusDescriptor = $convert.base64Decode(
    ...
    'NpbmcSPAoFaGVkZ2UYGSABKAsyIS5rZG8udjEuZnV0dXJlc19scC5GdXR1cmVzTHBIZWRnZUgD'
    'UgVoZWRnZYgBAUIRCg9fYmlkX2FkanVzdG1lbnRCEQoPX2Fza19hZGp1c3RtZW50QhEKD19xdW'
    'FudGl0eV9saW1pdEIICgZfaGVkZ2VKBAgJEApKBAgOEA9KBAgPEBBKBAgQEBFKBAgREBJKBAgS'
    'EBNSBWNhcnJ5UhBtb21lbnR1bV9lbmFibGVkUg9tb21lbnR1bV93aW5kb3dSFG1vbWVudHVtX3'
...
final $typed_data.Uint8List futuresLpStatusUpdateDescriptor = $convert.base64Decode(
    ...
    'JpY2luZxgVIAEoCUgMUgpldGZQcmljaW5niAEBQggKBl9zdGF0ZUIKCghfcHJpY2luZ0ISChBf'
    'ZmlsbF9zdGF0aXN0aWNzQgwKCl9hc2tfYmFzaXNCDAoKX2JpZF9iYXNpc0IRCg9fYmlkX2Fkan'
    'VzdG1lbnRCEQoPX2Fza19hZGp1c3RtZW50Qg8KDV9iaWRfcXVhbnRpdHlCDwoNX2Fza19xdWFu'
    'dGl0eUIJCgdfb2Zmc2V0QhEKD19xdWFudGl0eV9saW1pdEIICgZfZGVwdGhCDgoMX2V0Zl9wcm'
    'ljaW5nSgQIBhAHSgQIDhAPSgQIDxAQSgQIEBARSgQIERASSgQIEhATUgVjYXJyeVIQbW9tZW50'
    'dW1fZW5hYmxlZFIPbW9tZW50dW1fd2luZG93UhRtb21lbnR1bV9zZW5zaXRpdml0eVIXbW9tZW'
    '50dW1fYmlkX2FkanVzdG1lbnRSF21vbWVudHVtX2Fza19hZGp1c3RtZW50');
...
final $typed_data.Uint8List updateFuturesLpRequestDescriptor = $convert.base64Decode(
    ...
    '1pdIgBARIkCgtldGZfcHJpY2luZxgQIAEoCUgJUgpldGZQcmljaW5niAEBQg8KDV9iaWRfcXVh'
    'bnRpdHlCDwoNX2Fza19xdWFudGl0eUIRCg9fYmlkX2FkanVzdG1lbnRCEQoPX2Fza19hZGp1c3'
    'RtZW50QgwKCl9iaWRfYmFzaXNCDAoKX2Fza19iYXNpc0IICgZfZGVwdGhCCQoHX29mZnNldEIR'
    'Cg9fcXVhbnRpdHlfbGltaXRCDgoMX2V0Zl9wcmljaW5nSgQIAxAESgQIDBANSgQIDRAOSgQIDh'
    'APUgVjYXJyeVIQbW9tZW50dW1fZW5hYmxlZFIPbW9tZW50dW1fd2luZG93UhRtb21lbnR1bV9z'
    'ZW5zaXRpdml0eQ==');
