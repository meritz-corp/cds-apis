...
const LimitPriceType$json = {
  ...
  '2': [
    ...
    {'1': 'LIMIT_PRICE_TYPE_BEST_TAKE_PLUS_1', '2': 2},
    {'1': 'LIMIT_PRICE_TYPE_BEST_TAKE_PLUS_2', '2': 3},
    {'1': 'LIMIT_PRICE_TYPE_BEST_TAKE_PLUS_3', '2': 4},
    {'1': 'LIMIT_PRICE_TYPE_BEST_MAKE_MINUS_1', '2': 5},
    {'1': 'LIMIT_PRICE_TYPE_BEST_MAKE_MINUS_2', '2': 6},
    {'1': 'LIMIT_PRICE_TYPE_BEST_MAKE_MINUS_3', '2': 7},
  ],
};
...
final $typed_data.Uint8List limitPriceTypeDescriptor = $convert.base64Decode(
    ...
    'lNSVRfUFJJQ0VfVFlQRV9CRVNUX1RBS0UQARIlCiFMSU1JVF9QUklDRV9UWVBFX0JFU1RfVEFL'
    'RV9QTFVTXzEQAhIlCiFMSU1JVF9QUklDRV9UWVBFX0JFU1RfVEFLRV9QTFVTXzIQAxIlCiFMSU'
    '1JVF9QUklDRV9UWVBFX0JFU1RfVEFLRV9QTFVTXzMQBBImCiJMSU1JVF9QUklDRV9UWVBFX0JF'
...
const SubmitOrderRequest$json = {
  ...
  '2': [
    ...
    {'1': 'slot_id', '3': 14, '4': 1, '5': 9, '9': 6, '10': 'slotId', '17': true},
  ],
  '8': [
...
final $typed_data.Uint8List submitOrderRequestDescriptor = $convert.base64Decode(
    ...
    'LnYxLm9yZGVyLlF1aWNrT3JkZXJPcmlnaW5IBVIQcXVpY2tPcmRlck9yaWdpbogBARIcCgdzbG'
    '90X2lkGA4gASgJSAZSBnNsb3RJZIgBAUIWChRfYXV0b19hbWVuZF9zdHJhdGVneUITChFfbGlt'
    'aXRfcHJpY2VfdHlwZUISChBfb3JkZXJfY29uZGl0aW9uQg0KC19uZWVkX2hlZGdlQh0KG19hdX'
    'RvX2FtZW5kX2luaXRpYWxfd2FpdF9tc0IVChNfcXVpY2tfb3JkZXJfb3JpZ2luQgoKCF9zbG90'
    'X2lk');
...
const AmendOrderRequest$json = {
  ...
  '10': ['quantity', 'side', 'is_lp', 'quote_type', 'fund_code', 'order_condition'],
};
...
final $typed_data.Uint8List amendOrderRequestDescriptor = $convert.base64Decode(
    ...
    'ASgJQgTiQQECUgVwcmljZUoECAIQA0oECAQQBUoECAYQB0oECAcQCEoECAgQCUoECAkQCkoECA'
    'oQC1IIcXVhbnRpdHlSBHNpZGVSBWlzX2xwUgpxdW90ZV90eXBlUglmdW5kX2NvZGVSD29yZGVy'
    'X2NvbmRpdGlvbg==');
...
final $typed_data.Uint8List cancelOrderRequestDescriptor = $convert.base64Decode(
    ...
    '9yaWdpbmFsT3JkZXJJZBIcCgZzeW1ib2wYAyABKAlCBOJBAQJSBnN5bWJvbEoECAIQA0oECAQQ'
    'BUoECAYQB1IJZnVuZF9jb2RlUgRzaWRl');
...
const ListAllUnfilledOrdersRequest$json = {
  ...
  '2': [
    ...
    {'1': 'side', '3': 3, '4': 1, '5': 14, '6': '.kdo.v1.common.OrderSide', '9': 2, '10': 'side', '17': true},
  ],
  '8': [
    {'1': '_fund_code'},
    {'1': '_symbol'},
...
final $typed_data.Uint8List listAllUnfilledOrdersRequestDescriptor = $convert.base64Decode(
    ...
    '5kQ29kZYgBARIbCgZzeW1ib2wYAiABKAlIAVIGc3ltYm9siAEBEjEKBHNpZGUYAyABKA4yGC5r'
    'ZG8udjEuY29tbW9uLk9yZGVyU2lkZUgCUgRzaWRliAEBQgwKCl9mdW5kX2NvZGVCCQoHX3N5bW'
    'JvbEIHCgVfc2lkZQ==');
...
final $typed_data.Uint8List orderResultDescriptor = $convert.base64Decode(
    ...
    'lSBnN5bWJvbBIbCglmdW5kX2NvZGUYAyABKAlSCGZ1bmRDb2RlEiwKBHNpZGUYBCABKA4yGC5r'
    'ZG8udjEuY29tbW9uLk9yZGVyU2lkZVIEc2lkZRIUCgVwcmljZRgFIAEoCVIFcHJpY2USGgoIcX'
    'VhbnRpdHkYBiABKANSCHF1YW50aXR5Ej4KC3Jlc3VsdF90eXBlGAcgASgOMh0ua2RvLnYxLm9y'
    'ZGVyLk9yZGVyUmVzdWx0VHlwZVIKcmVzdWx0VHlwZRI4Cgl0aW1lc3RhbXAYCCABKAsyGi5nb2'
    '9nbGUucHJvdG9idWYuVGltZXN0YW1wUgl0aW1lc3RhbXASOwoIcmVjZWl2ZWQYCiABKAsyHS5r'
    'ZG8udjEub3JkZXIuUmVjZWl2ZWREZXRhaWxzSABSCHJlY2VpdmVkEjsKCHJlamVjdGVkGAsgAS'
    'gLMh0ua2RvLnYxLm9yZGVyLlJlamVjdGVkRGV0YWlsc0gAUghyZWplY3RlZBI1CgZmaWxsZWQY'
    'DCABKAsyGy5rZG8udjEub3JkZXIuRmlsbGVkRGV0YWlsc0gAUgZmaWxsZWQSPgoJY2FuY2VsbG'
    'VkGA0gASgLMh4ua2RvLnYxLm9yZGVyLkNhbmNlbGxlZERldGFpbHNIAFIJY2FuY2VsbGVkQgkK'
    'B2RldGFpbHM=');
...
const Order$json = {
  ...
  '2': [
    ...
    {'1': 'order_side', '3': 2, '4': 1, '5': 14, '6': '.kdo.v1.common.OrderSide', '10': 'orderSide'},
...
final $typed_data.Uint8List orderDescriptor = $convert.base64Decode(
    'CgVPcmRlchIZCghvcmRlcl9pZBgBIAEoCVIHb3JkZXJJZBI3CgpvcmRlcl9zaWRlGAIgASgOMh'
    'gua2RvLnYxLmNvbW1vbi5PcmRlclNpZGVSCW9yZGVyU2lkZRIWCgZzeW1ib2wYAyABKAlSBnN5'
