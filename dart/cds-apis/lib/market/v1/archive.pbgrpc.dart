...
import 'archive.pb.dart' as $0;

export 'archive.pb.dart';

/// 호가 서비스
@$pb.GrpcServiceName('market.v1.archive.OrderbookService')
...
abstract class OrderbookServiceBase extends $grpc.Service {
  $core.String get $name => 'market.v1.archive.OrderbookService';
...
/// 체결 서비스
@$pb.GrpcServiceName('market.v1.archive.TradeService')
...
abstract class TradeServiceBase extends $grpc.Service {
  $core.String get $name => 'market.v1.archive.TradeService';
...
/// OHLC 서비스
@$pb.GrpcServiceName('market.v1.archive.CandleService')
...
abstract class CandleServiceBase extends $grpc.Service {
  $core.String get $name => 'market.v1.archive.CandleService';
...
/// 종목 서비스
@$pb.GrpcServiceName('market.v1.archive.SymbolService')
...
abstract class SymbolServiceBase extends $grpc.Service {
  $core.String get $name => 'market.v1.archive.SymbolService';
...
/// 지표 서비스 (Phase 2)
@$pb.GrpcServiceName('market.v1.archive.IndicatorService')
...
abstract class IndicatorServiceBase extends $grpc.Service {
  $core.String get $name => 'market.v1.archive.IndicatorService';
...
/// 적재 서비스 (Admin)
@$pb.GrpcServiceName('market.v1.archive.IngestionService')
...
abstract class IngestionServiceBase extends $grpc.Service {
  $core.String get $name => 'market.v1.archive.IngestionService';
